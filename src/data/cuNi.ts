...
export const cuNi: PhaseDiagramDefinition = {
  ...
  boundaries: [
    ...
    },
    {
      ...
      // 加强下凹形态：以两端熔点为硬锚点，按平滑二次曲率展开，
      // 使中部明显远离端点连线，同时保持温度严格递增、斜率严格递增。
      points: [[0, 1085], [5, 1085.9], [10, 1088.7], [15, 1093.3], [20, 1099.8], [25, 1108.1], [30, 1118.3], [35, 1130.3], [40, 1144.2], [45, 1159.9], [50, 1177.5], [55, 1196.9], [60, 1218.2], [65, 1241.3], [70, 1266.3], [75, 1293.1], [80, 1321.8], [85, 1352.3], [90, 1384.7], [95, 1418.9], [100, 1455]],
    },
  ],
  regions: [
    {
