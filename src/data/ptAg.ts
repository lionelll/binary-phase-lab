...
export const ptAg: PhaseDiagramDefinition = {
  ...
  regions: [
    ...
    { id:'liquid-beta', label:'L + β', phases:['L','β'], labelAnchor:[82,1080], labelOffset:{dx:0,dy:-12}, teaching:'液相与 β 固相平衡共存。', tieLine:{left:{phase:'β',boundaryId:'beta-solidus'},right:{phase:'L',boundaryId:'liquidus-right'}}, outline:[{type:'boundary',boundaryId:'liquidus-right'},{type:'boundary',boundaryId:'beta-solidus',reverse:true},{type:'line',points:[[42.4,1186],[66.3,1186]]}] },
