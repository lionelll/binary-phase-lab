...
export function InfoPanel({diagram,state,module}:{diagram:PhaseDiagramDefinition;state:PhaseState;module:ModuleId}){
  ...
  return <aside className="panel-stack right-rail">
    <section className="panel info-card"><div className="card-title"><span><Icon name="info"/>当前信息</span></div><dl className="info-grid">
    ...
    <section className="panel balance-card"><div className="card-title"><span><Icon name="lever"/>相平衡</span></div><div className="balance-content">
