export type IconName = 'home' | 'reset' | 'play' | 'diagram' | 'cooling' | 'lever' | 'reaction' | 'micro' | 'info' | 'settings' | 'chevron';
...
export function Icon({ name, className }: { name: IconName; className?: string }) {
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    micro: <><circle cx="11" cy="11" r="6"/><path d="m20 20-4.5-4.5"/><path d="M8.5 11h5M11 8.5v5"/></>,
